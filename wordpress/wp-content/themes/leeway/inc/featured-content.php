...
class Leeway_Featured_Content {
	 ...
	 *
	 * @see Leeway_Featured_Content::init()
	 *
	 * @since Leeway 1.0
	 *
	 * @static
	 ...
	 *
	 * @see Leeway_Featured_Content::validate_settings().
	 *
	 * @static
	 * @access public
	 * @since Leeway 1.0
	 ...
	 * the transient is deleted by Leeway_Featured_Content::validate_settings().
	 *
	 ...
	 *
	 * @uses Leeway_Featured_Content::get_setting()
	 */
	...
	public static function customize_register( $wp_customize ) {
		$wp_customize->add_section( 'featured_content', array(
			'title'          => __( 'Featured Content', 'leeway' ),
			'description'    => sprintf( __( 'Use a <a href="%1$s">tag</a> to feature your posts. If no posts match the tag, <a href="%2$s">sticky posts</a> will be displayed instead.', 'leeway' ),
				esc_url( add_query_arg( 'tag', _x( 'featured', 'featured content default tag slug', 'leeway' ), admin_url( 'edit.php' ) ) ),
		...
		$wp_customize->add_setting( 'featured-content[tag-name]', array(
			'default'              => _x( 'featured', 'featured content default tag slug', 'leeway' ),
			'type'                 => 'option',
		...
		$wp_customize->add_control( 'featured-content[tag-name]', array(
			'label'    => __( 'Tag Name', 'leeway' ),
			'section'  => 'featured_content',
			'priority' => 20,
		) );
		$wp_customize->add_control( 'featured-content[hide-tag]', array(
			'label'    => __( 'Don&rsquo;t display tag on front end.', 'leeway' ),
			'section'  => 'featured_content',
			'type'     => 'checkbox',
			'priority' => 30,
		) );
	...
	public static function get_setting( $key = 'all' ) {
		...
		$defaults = array(
			'hide-tag' => 1,
			'tag-id'   => 0,
			'tag-name' => _x( 'featured', 'featured content default tag slug', 'leeway' ),
		);
	 ...
	 * delete the transient set in Leeway_Featured_Content::get_featured_content().
	 *
	 * @static
	 * @access public
	 * @since Leeway 1.0
...
} // Leeway_Featured_Content

Leeway_Featured_Content::setup();
